    ...
    <header className="fixed top-0 left-0 right-0 z-50">
      ...
      <nav
        className={`h-11 md:h-12 flex items-center justify-between px-4 md:px-8 transition-all duration-300 ${
          scrolled || isOpen || searchOpen ? "bg-black/90 backdrop-blur-md" : "bg-black/80 backdrop-blur-sm"
        }`}
      >
        {/* Logo Apple */}
          ...
          >
            <div className="max-w-2xl mx-auto relative">
              ...
              <input
                ...
                className="w-full bg-gray-800/70 text-white rounded-lg py-2 pl-10 pr-4 focus:outline-none focus:ring-2 focus:ring-blue-500"
                autoFocus
              />
            </div>
          </motion.div>
