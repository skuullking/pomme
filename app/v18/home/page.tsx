...
export default function HomePage() {
  ...
  useEffect(() => {
    // Si l'utilisateur n'est pas authentifié, définir comme invité par défaut
    if (!localStorage.getItem("user_v18") && !localStorage.getItem("guestUser_v18")) {
      ...
      >
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link href="/v18/compare" className="text-blue-500 hover:text-blue-400 flex items-center text-lg">
              Découvrir <ChevronRight size={16} />
            </Link>
            <Link href="/v18/checkout" className="text-blue-500 hover:text-blue-400 flex items-center text-lg">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            >
              ...
              <Link
                href="/v18/compare?model=iphone16"
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row-reverse items-center gap-8">
            ...
            >
              ...
              <Link
                href="/v18/compare?model=iphone16pro"
                className="text-blue-500 hover:text-blue-400 flex items-center text-lg"
              >
                En savoir plus <ChevronRight size={16} />
              </Link>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <Link href="/v18/compare" className="text-gray-500 hover:text-white text-sm">
                    iPhone
                  </Link>
                </li>
                <li>
                  <Link href="/v18/price-tracker" className="text-gray-500 hover:text-white text-sm">
                    Comparateur de prix
                  </Link>
                </li>
                <li>
                  <Link href="/v18/checkout" className="text-gray-500 hover:text-white text-sm">
                    Acheter
                  </Link>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <Link href="/v18/login" className="text-gray-500 hover:text-white text-sm">
                    Gérer votre compte
                  </Link>
                </li>
                <li>
                  <Link href="/v18/account" className="text-gray-500 hover:text-white text-sm">
                    Profil Apple
                  </Link>
                </li>
                <li>
