          ...
          <Card className="bg-gray-950 border-gray-800 text-white shadow-xl">
            ...
            <CardContent>
              ...
              <div className="mt-4 text-center text-sm text-gray-400">
                ...
                <Link href="/v14/login" className="text-blue-500 hover:underline">
                  Se connecter
                </Link>
              </div>
              <div className="mt-2 text-center text-sm">
                <Link href="/v14/login-choice" className="text-gray-500 hover:underline">
