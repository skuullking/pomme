...
export default function LoginChoicePage() {
  ...
  const handleContinueAsGuest = () => {
    // Rediriger vers la page d'accueil en tant qu'invité
    // Définir un état invité dans le localStorage pour indiquer que l'utilisateur est connecté en tant qu'invité
